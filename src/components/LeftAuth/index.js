...
const LeftAuth = () => {
  return (
    <Container>
      ...
      <p className="text-white text-title">App that Covering Banking Needs.</p>
      <p className="text-white text-info-app">Abusayap is an application that focussing in banking needs for all users
